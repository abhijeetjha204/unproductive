      ...
      <div className="flex items-center gap-6">
        <div className="hidden sm:flex items-center gap-6 text-sm font-medium text-zinc-400">
          ...
          >
            ...
            <span className="hidden lg:block">@abhijitwt</span>
          </a>
          <a
          ...
          >
            ...
            <span className="hidden lg:block">Abhijit-Jha</span>
          </a>
        </div>
        <a
          ...
          className="inline-flex items-center justify-center gap-2 px-5 py-2 sm:px-6 sm:py-2.5 bg-zinc-900 border border-white/10 hover:border-orange-500/50 hover:bg-orange-500/10 text-white font-medium rounded-full transition-all duration-300"
        >
          <Download className="w-4 h-4 text-orange-400" />
          <span className="text-sm">Download Extension</span>
        </a>
      </div>
    </header>
  );
